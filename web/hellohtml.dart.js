...
$$.Object_ListMixin2 = {"": "Object+ListMixin;", $isList: true, $asList: function() { return [$.JSString]; }, $isIterable: true, $asIterable: function() { return [$.JSString]; }};

$$.Object_ListMixin_ImmutableListMixin2 = {"": "Object_ListMixin2+ImmutableListMixin;", $isList: true, $asList: function() { return [$.JSString]; }, $isIterable: true, $asIterable: function() { return [$.JSString]; }};
...
$$.textCursor = {"": "Object;x>,y>,dx,dy,r"};

$$.svgText = {"": "Object;cursor,fontSize,x>,y>,lines,currentLine,currentChar,fontFamily,id>,textArea",
  addNewLine$1: function(_text) {
    var temp, t1;
    temp = document.createElementNS("http://www.w3.org/2000/svg", "tspan");
    temp.setAttribute("x", "" + this.x + "px");
    temp.setAttribute("y", $.S(this.lines * this.fontSize) + "px");
    temp.setAttribute("id", this.id + "_line" + $.S(this.lines));
    temp.textContent = _text;
    t1 = $.get$children$x(this.textArea);
    t1.add$1(t1, temp);
    this.lines = this.lines + 1;
  },
  svgText$5: function(_id, _fontSize, _x, _y, _fontFamily) {
    this.lines = 1;
    this.currentLine = 2;
    this.currentChar = 1;
    this.x = _x;
    ...
    this.textArea = $.TextElement_TextElement();
    this.textArea.setAttribute("x", "" + this.x + "px");
    this.textArea.setAttribute("y", "" + this.y + "px");
    this.textArea.setAttribute("id", this.id);
    this.textArea.setAttribute("font-family", this.fontFamily);
    this.textArea.setAttribute("font-size", "" + this.fontSize);
    this.cursor = $.textCursor$();
    this.textArea.textContent = "testestes";
  }
};
...
$$.KeyboardEvent = {"": "UIEvent;$$dom_keyIdentifier:keyIdentifier="};
...
$$.UIEvent = {"": "Event;$$dom_keyCode:keyCode=",
  get$pageX: function(receiver) {
    return this.get$page(receiver).x;
  },
...
$$.StringList = {"": "Object_ListMixin_ImmutableListMixin2;",
  $index: function(receiver, index) {
...
$.main = function() {
  var t1, out, textF, i, t2;
  t1 = $.HtmlDocument_methods.get$onKeyPress(document);
  $._EventStreamSubscription$(t1._target, t1._eventType, $.pressedKey, t1._useCapture);
  t1 = $.HtmlDocument_methods.get$onClick(document);
  $._EventStreamSubscription$(t1._target, t1._eventType, $.clicked, t1._useCapture);
  out = document.querySelector("#output");
  textF = $.svgText$("svTs", 25, 30, 10, "Verdana");
  for (i = 0; i < 20; ++i)
    textF.addNewLine$1("" + i + ".hello world");
  t1 = $.get$children$x(out);
  t1.add$1(t1, textF.textArea);
  $.textInput = textF;
  $.Primitives_printString($.toString$0($.get$cmdWindow().className));
  t1 = document.querySelector("#display");
  t2 = $.get$modeList();
  if (0 >= t2.length)
    throw $.ioore(0);
  t1.textContent = t2[0];
...
$.clicked = function($event) {
  $.Primitives_printString($.toString$0($.get$pageX$x($event)));
};

$.textCursor$ = function() {
  return new $.textCursor(null, null, null, null, null);
};

$.svgText$ = function(_id, _fontSize, _x, _y, _fontFamily) {
  var t1 = new $.svgText(null, null, null, null, null, null, null, null, null, null);
  t1.svgText$5(_id, _fontSize, _x, _y, _fontFamily);
  return t1;
};
...
$.modeChange = function(_mode) {
  ...
  switch (_mode) {
    case 0:
      $.Primitives_printString("called");
      $.set$value$x($.get$cmdWindow(), "");
      t1 = $.get$classes$x($.get$cmdWindow());
      t1.remove$1(t1, "show");
      t1 = $.get$classes$x($.get$cmdWindow());
      t1.add$1(t1, "hide");
      break;
...
$.pressedKey = function($event) {
  ...
  switch (t1.get$$$dom_keyCode($event)) {
    case 58:
      $.Primitives_printString("this is cmd");
      $.modeChange(2);
      break;
    case 105:
      for (last = 0, i = 0; i < 11; ++i) {
        t2 = $.textInput;
        t2 = $.S($.$index$asx(t2.get$text(t2), i)) + "  ";
        t3 = $.textInput;
        $.Primitives_printString(t2 + $.S($.$sub$n($.get$x$x(t3.getStartPositionOfChar$1(t3, i)), last)));
        t3 = $.textInput;
        last = $.get$x$x(t3.getStartPositionOfChar$1(t3, i));
      }
      $.modeChange(1);
      break;
    case 27:
      ...
      break;
    default:
      $.Primitives_printString("default root");
      break;
  }
  $.Primitives_printString($.S(t1.get$$$dom_keyCode($event)) + " " + $.S(t1.get$$$dom_keyIdentifier($event)));
};
...
$.clicked.call$1 = $.clicked;
$.clicked.$name = "clicked";
$.pressedKey.call$1 = $.pressedKey;
$.pressedKey.$name = "pressedKey";
...
$.get$pageX$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$pageX(receiver);
};
...
Isolate.$lazy($, "modeList", "modeList", "get$modeList", function() {
  return ["Normal Mode", "Insert Mode", "CommandLine Mode", "Visual Mode", "Search Mode"];
});
Isolate.$lazy($, "cmdWindow", "cmdWindow", "get$cmdWindow", function() {
  return $.query("#input");
});
// Native classes
...
//@ sourceMappingURL=hellohtml.dart.js.map
